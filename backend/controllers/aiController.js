...
const {conceptExplainPrompt, questionAnswerPrompt, checkAnswersPrompt} = require("../utils/prompts");
...
const checkAnswers = async (req, res) => {
    try {
        ...
        const prompt = checkAnswersPrompt(qsnAnsObject)
...
module.exports = {generateInterviewQuestions, generateConceptExplanation, checkAnswers}